...
export default ({ cards = null, heading = "Why Join Us", subheading = "Membership", description = "We are not a product of my circumstances. We are a product of my decisions." }) => {
  /*

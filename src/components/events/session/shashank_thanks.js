...
export default ({
  ...
  heading = "Feb. 01st 2021, 15:00 - 16:00 IST",
  description = "Thank you for registering for the speaker session. You have registered for Intro to Placments.",
  textOnLeft = false,
  testimonials = [
    {
      quote:
        "We're also going to send you a mail before event starts."
    }
  ]
}) => {
  return (
